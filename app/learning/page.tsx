...
export default function RLLearningPage() {
  ...
  const recentOutcomes = [
    ...
    },
    {
      ...
      penalties: {
        sla: "-2.0 (Breach)",
        regression: "-2.2 (Connection Drops)",
        resource: 0,
      },
    },
  ];
      ...
      <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">
            Autonomous action effectiveness and behavior preference shifts.
          </p>
        </div>
      ...
      <div className="bg-emerald-950/20 border border-emerald-900/50 p-4 rounded-xl flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-1 leading-relaxed">
            The Reinforcement Learning engine optimizes for MTTR and SLA
            preservation, but operates strictly beneath the Policy Engine. RL
            preferences <strong>never</strong> override manual configuration,
            confidence gates, shadow validation results, or operator
            permissions.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <section className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
            <h2 className="text-sm font-semibold text-zinc-300 uppercase tracking-wider mb-4 flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-zinc-500" /> Action Preference
              Shifts
            </h2>
              ...
              {actionPreferences.map((pref, idx) => (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <span className="text-sm font-medium text-zinc-300 font-mono truncate mr-2">
                      {pref.action}
                    </span>
                    <span
          ...
          <section className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
            ...
            <div className="space-y-3">
              {serviceEffectiveness.map((svc, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between p-2 rounded hover:bg-zinc-800/50"
                >
        ...
        <div className="lg:col-span-2 space-y-6">
          <section className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 h-full">
            <h2 className="text-sm font-semibold text-zinc-300 uppercase tracking-wider mb-4 flex items-center gap-2">
              <Activity className="w-4 h-4 text-zinc-500" /> Recent Learning
              Outcomes
            </h2>
            ...
            <div className="space-y-4">
              {recentOutcomes.map((outcome, idx) => (
                <div
                  key={idx}
                  className="p-5 bg-zinc-950 rounded-lg border border-zinc-800 overflow-hidden relative"
                >
                      ...
                      <div className="bg-black/50 p-3 rounded-lg border border-zinc-800/80">
                        ...
                        <ul className="space-y-1 text-xs">
                          ...
                          <li className="flex justify-between">
                            ...
                            <span
                              className={
                                outcome.penalties.regression === 0
                                  ? "text-zinc-600"
                                  : "text-red-400 font-mono"
                              }
                            >
