      ...
      <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">
            Safe chaos injection and shadow validation for LLM remediation.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 flex gap-4 border-t border-zinc-800 mt-6">
                {!chaosActive ? (
                  ...
                  >
                    <Square className="w-4 h-4" fill="currentColor" /> ABORT
                    CHAOS
                  </button>
                )}
              </div>
          ...
          <section className="bg-zinc-900 border border-zinc-800 rounded-xl flex flex-col h-full relative overflow-hidden">
            <div className="p-6 border-b border-zinc-800 bg-zinc-950/30">
              ...
              <p className="text-sm text-zinc-400 mb-6">
                Compare generated candidates and validate safely in isolated
                sandbox.
              </p>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-2">
                        <Zap
                          className={`w-4 h-4 ${selectedCandidate === 1 ? "text-purple-400" : "text-zinc-500"}`}
                        />
                    ...
                    <div className="grid grid-cols-3 gap-2 text-xs">
                      ...
                      <div className="text-zinc-400">
                        Cost: <span className="text-zinc-300">+$2.50/mo</span>
                      </div>
                      <div className="text-zinc-400">
                        Recovery:{" "}
                        <span className="text-zinc-300">&lt; 10s</span>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-2">
                        <Scale
                          className={`w-4 h-4 ${selectedCandidate === 2 ? "text-purple-400" : "text-zinc-500"}`}
                        />
                        <span className="font-bold text-zinc-200">
                          Scale Replicas (x3)
                        </span>
                    ...
                    <div className="grid grid-cols-3 gap-2 text-xs">
                      ...
                      <div className="text-zinc-400">
                        Cost:{" "}
                        <span className="text-orange-400">+$45.00/mo</span>
                      </div>
                      <div className="text-zinc-400">
                        Recovery: <span className="text-zinc-300">~ 45s</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {shadowState === "running" && (
                <div className="space-y-2 py-4">
                  <div className="flex justify-between text-xs font-mono text-zinc-400">
                    <span>
                      Evaluating Candidate #{selectedCandidate} in Shadow
                      Cluster...
                    </span>
                    <span>{progress}%</span>
                  </div>
              ...
              <div className="p-6 bg-emerald-950/10 flex-1 animate-in fade-in duration-500 border-t border-zinc-800">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div>
                    ...
                    <div className="text-sm font-medium text-zinc-300 mt-3">
                      Error Rate
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="text-sm font-mono text-red-400 mt-3">
                      8.4%
                    </div>
                  </div>
                  <div>
                ...
                <div className="p-3 bg-zinc-950 rounded border border-zinc-800">
                  <div className="text-xs text-zinc-500 font-mono mb-1">
                    SHADOW ENGINE CONCLUSION
                  </div>
                  <p className="text-sm text-zinc-300 leading-relaxed">
                    Memory patch resolved crash loop. No secondary regressions
                    detected in API Gateway or Payment Service. Candidate is
